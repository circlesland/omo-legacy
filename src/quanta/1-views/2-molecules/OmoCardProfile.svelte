<div class="font-sans leading-tight bg-grey-lighter p-8">
  <div class="max-w-sm mx-auto bg-white rounded-lg shadow-lg">
    ...
    <div class="border-b px-4 pb-6">
          ...
          <div class="inline-flex text-grey-dark sm:flex items-center">
            <svg
              ...
              <path
                ...
                0l-5.65-5.66zm11.31-1.41a7 7 0 1 0-9.9 0L12 19.9l4.95-4.95zM12
                14a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm0-2a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" />
            </svg>
            New York, NY
          </div>
        </div>
      ...
      <div class="flex">
        <button
          class="flex-1 rounded-full bg-green-400 font-semibold text-white
          hover:bg-blue-800 px-4 py-2 mx-2">
          Follow
        </button>
        <button
          class="flex-1 rounded-full border-2 border-grey font-semibold mx-2
    ...
    <div class="px-4 py-4">
      <div class="flex items-center text-grey-darker mb-4">
        <svg
          ...
          <path
            class="heroicon-ui"
            d="M12 12a5 5 0 1 1 0-10 5 5 0 0 1 0 10zm0-2a3 3 0 1 0 0-6 3 3 0 0 0
            0 6zm9 11a1 1 0 0 1-2 0v-2a3 3 0 0 0-3-3H8a3 3 0 0 0-3 3v2a1 1 0 0
            1-2 0v-2a5 5 0 0 1 5-5h8a5 5 0 0 1 5 5v2z" />
        </svg>
        <span>
      ...
      <div class="flex">
        ...
        <span
          class="flex items-center justify-center text-sm text-grey-darker
          font-semibold border-2 border-grey-light rounded-full h-10 w-10">
          +3
        </span>
      </div>
    </div>
