// omo.quant(
//     class TableView extends omo.quantum.get("omo", "quantum", "quant") {
...
//             console.log(value);
//             const quant = null;// TODO omo.quanta[value];
//             if (quant === undefined) {
//                 return;
//             }
...
//                 case 'boolean':
//                     return omo.html`
//         <input name="${name}" type="checkbox" ?checked="${entry[name]}" data-id="${entry.ID}" @change="${this.changed}"
//             @focus="${this.updatePreview}">`;
//                 case 'date':
//                 case 'number':
//                 case 'email':
//                 case 'password':
...
//             return omo.html`<tr>
//     <td class="px-4 py-2"><button class="border text-green-400 border-green-400 rounded-full px-2"
//             @click="${this.createNew}">add row</button></td>
// </tr>`;
//         }
...
//                 ? omo.html`
//         <div class="py-1 px-2">
//             <button class="border text-red-400 border-red-400 rounded-full px-2" @click="${this.delete}"
//                 data-id="${id}">delete</button>
//             <button class="border text-red-400 border-red-400 rounded-full px-2" @click="${this.openItemView}"
//                 data-id="${id}">ItemView</button>
//             <button class="border text-red-400 border-red-400 rounded-full px-2" @click="${this.showView}"
//                 data-id="${id}">Show</button>
...
//             const newQuant = omo.quantum.get("omo", "quantum", "itemview");// TODO  new omo.quanta.ItemView();
